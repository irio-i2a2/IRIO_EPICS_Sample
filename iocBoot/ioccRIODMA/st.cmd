#!../../bin/linux-x86_64/cRIODMA

## You may have to change cRIODMA to something else
...
dbLoadDatabase "dbd/cRIODMA.dbd"
cRIODMA_registerRecordDeviceDriver pdbbase

##Init Irio Device

nirioinit("RIO_0","019ED079","NI 9159","cRIODAQDMA_9159","V1.1",1)
